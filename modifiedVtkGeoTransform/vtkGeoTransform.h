...
public:
  ...
  PJ *transformation;
  double srcToRadians;
  double destToRadians;
  double RAD_TO_DEG;
  bool srcIsLongLat;
  bool destIsLongLat;
  const char *oform;
  bool GetSrcIsLongLat();
  void SetSrcIsLongLat(bool val);
  bool GetDestIsLongLat();
  void SetDestIsLongLat(bool val);
  ...
  vtkPoints* process(float *pointlist, int numPoints);
protected:
  vtkGeoTransform();
  ...
  //static double srcToRadians;
  //static double destToRadians;
  //static double RAD_TO_DEG;
  //static bool srcIsLongLat;
  //static bool destIsLongLat;
